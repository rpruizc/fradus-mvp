...
Core message (the through-line for all three):
...
> Would you be open to a 20-minute design-partner call?

---

## 1. LinkedIn message (under 500 characters)
...
## 2. Cold email (under 150 words)

Subject: corrected fraud labels for [Company]'s model

Hi [First name],

Fraud models trained on chargebacks systematically undercount true fraud because
declined, unreported, delayed, and miscoded transactions disappear from the training
...
We're selecting a small group of design partners for paid historical backtests.
...
## 3. Follow-up email (under 100 words)

Subject: re: corrected fraud labels for [Company]'s model
...
Worth a 20-minute design-partner call to see if your portfolio is a fit?
